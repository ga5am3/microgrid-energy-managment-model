...
def evaluation(pop,day):
    with concurrent.futures.ProcessPoolExecutor() as executor:
        results=[]
        for p in pop:
            # for each trayectory this computes the objective function for a given day in parallel
...
def initialization(day):
    ...
    """
    # initializa 100 iniciales con 24 acciones a tomar en un dia en un espacio discreto de [4,5,2,2]
